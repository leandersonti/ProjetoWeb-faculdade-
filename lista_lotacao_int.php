...
<body>
	<div style="width:80%; margin:100px auto" class="panel panel-defalt">
			...
			<div class="form-row">
				<div class="form-group col-md-3">
					<select name="equipamento" class="form-control">
						...
						<?php
						$query = "SELECT * FROM emprestimo emp,equipamento_emprestado el,equipamento e WHERE el.num_serie=e.num_serie and el.protocolo=emp.protocolo and lot_status=0 and federacao=1 ORDER BY tipo";
				...
				<div class="form-group col-md-3">
					<select name="responsavel" class="form-control">
						...
						<?php
						$query = "SELECT * FROM emprestimo emp,equipamento_emprestado el,equipamento e WHERE el.num_serie=e.num_serie and el.protocolo=emp.protocolo and lot_status=0 and federacao=1 ORDER BY responsavel";
						$result = mysqli_query($conn,$query);
						while ($rs = mysqli_fetch_object($result))
						{
				...
				<div class="form-group col-md-3">
					<select name="dpto" class="form-control">
						...
						<?php
						$query = "SELECT * FROM emprestimo emp,equipamento_emprestado el,equipamento e WHERE el.num_serie=e.num_serie and el.protocolo=emp.protocolo and lot_status=0 and federacao=1 ORDER BY unipto";
						$result = mysqli_query($conn,$query);
						while ($rs = mysqli_fetch_object($result))
						{
		...
		<br>
		<?php
		$query = "SELECT COUNT(*) as qtdd FROM equipamento_emprestado, emprestimo WHERE lot_status=0 and federacao=1";
		$result = mysqli_query($conn,$query);
