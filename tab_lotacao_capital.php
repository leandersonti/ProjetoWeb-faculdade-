...
<?php
$sql = "SELECT COUNT(*) as qtdd FROM equipamento_emprestado eq, emprestimo emp WHERE lot_status=0 and federacao=0";
...
<div id="tabelinha" class="table">
	...
	if (isset($_POST['filtro'])) {
		$query = "SELECT * FROM emprestimo emp,equipamento_emprestado el,equipamento e WHERE el.num_serie=e.num_serie and el.protocolo=emp.protocolo and lot_status=0 and federacao=0";
		...
		$query = "SELECT * FROM emprestimo emp,equipamento_emprestado el,equipamento e WHERE el.num_serie=e.num_serie and el.protocolo=emp.protocolo and lot_status=0 and federacao=0 ORDER BY dt_lotacao";
	}
...
<script async type="text/javascript">
	function devolver(id) {
		...
		window.location.href = "devolver.php?prot=" + prot + "&serie=" + serie + "&local=capital";
